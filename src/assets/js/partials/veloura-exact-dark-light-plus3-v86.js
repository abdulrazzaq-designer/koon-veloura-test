...
(() => {
  ...
  const SHADOW_CSS = `
    :host {
      --v86-surface: rgba(228, 231, 235, .80);
      --v86-solid: #e6e8eb;
      --v86-edge-top: rgba(100, 116, 139, .20);
      --v86-edge-bottom: rgba(100, 116, 139, .12);
      --v86-shadow: rgba(15, 23, 42, .10);
    ...
    /* نافذة تسجيل الدخول داخل الظل: إطار أبيض، ولا يُفرض مخطط ألوان داكن
       على الصفحة داخل الإطار — color-scheme يسري إلى المستند المضمَّن
       فيقلب ألوان نصوصه الافتراضية إلى أبيض فوق خلفيته البيضاء. */
    :host(.s-login-modal),
    :host(.s-login-modal) *,
    iframe {
      color-scheme: light !important;
    ...
    :host(.s-login-modal) :is(.s-modal-body, .s-modal-content, .s-salla-modal-body),
    :is(.s-modal-body, .s-modal-content, .s-salla-modal-body):has(iframe) {
      background: #ffffff !important;
      background-color: #ffffff !important;
      background-image: none !important;
      -webkit-backdrop-filter: none !important;
